...
TEST_CASE("Simple derivatives vertical")
{
    ...
    f2 = Dim3MatMul<Map<const Array<stratifloat, -1, 1>, Aligned16>,stratifloat,stratifloat,2*(N1/2+1),N2,N3>(VerticalSecondDerivativeMatrix(L, N3, BoundaryCondition::Dirichlet), f1);
